...
export const INITIAL_VERSES: Verse[] = [
  {
    ...
    descricao: "Nenhuma palavra torpe saia da boca de vocês, mas apenas a que for útil para edificar os outros, conforme a necessidade, para que conceda graça aos que a ouvem. (NVI)",
    tema: "Comunicação",
  },
  {
    id: 2,
    referencia: "Hebreus 11:1",
    descricao: "Ora, a fé é a certeza daquilo que esperamos e a prova das coisas que não vemos. (NVI)",
    tema: "Fé",
  },
  {
    id: 3,
    referencia: "Filipenses 4:13",
    descricao: "Tudo posso naquele que me fortalece. (NVI)",
    tema: "Força",
  },
];
